...
if __name__ == '__main__':
        datasets = {
                    "glc": {"geoTiffPath": "/home/david/Downloads/glc2000_clipped.tif", "arrayName": "glc_2000_clipped", "attribute": "value", "outDirectory": "/home/david/scidb_data/0", }
                    #"glc": {"geoTiffPath": "/home/david/Downloads/glc2000.tif", "arrayName": "glc_2000", "attribute": "value", "outDirectory": "/home/david/scidb_data/0", }
        ...
        for d in datasets:
                ...
                raster = RasterLoader(datasets[d]["geoTiffPath"], datasets[d]["arrayName"], [datasets[d]["attribute"]], 1000, datasets[d]["outDirectory"], 1, 2000000)
